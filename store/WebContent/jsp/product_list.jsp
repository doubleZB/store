		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			<ul class="pagination" style="text-align:center; margin-top:10px;">
				...
				<c:if test="${pb.pageNumber==1}">
					<li class="disabled">
						<a href="${pageContext.request.contextPath}/product?method=findPage&pageNumber=${pb.pageNumber-1}&cid=${cid}" aria-label="Previous"><span aria-hidden="true">&laquo;</span>
						</a>
					</li>
				</c:if>
				<c:if test="${pb.pageNumber!=1}">
				...
				<c:if test="${pb.pageNumber==pb.totalPage}">
					<li class="disabled">
					<a href="${pageContext.request.contextPath}/product?method=findPage&pageNumber=${pb.pageNumber+1}&cid=${cid}" aria-label="Next">
				...
				<c:forEach begin="1" end="${pb.totalPage}" step="1" var="page">
						...
						<li><a href="${pageContext.request.contextPath}/product?method=findPage&pageNumber=${page}&cid=${cid}">${page}</a></li>
						</c:if>
